...
public availability date x x x x
theoretical peak perf** 1,011GF/s* x* 1,430GF/s 5,300GF/s
offload required yes no yes yes
max number of thread 240 272 2880 3584 
...
\subsubsection{K40 cluster}
The SURFsara institute in Nederland granted access to Cartesius which has a GPU island (May 2014) with following specifications [https://userinfo.surfsara.nl/systems/cartesius/description]:
...
\subsubsection{Xeon Phi 5110P cluster}
...
\subsubsection{P100 cluster}



\subsubsection{Xeon Phi 7250 cluster}
